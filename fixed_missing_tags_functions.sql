...
DROP FUNCTION IF EXISTS get_contacts_without_tags_count();
DROP FUNCTION IF EXISTS get_contacts_without_tags(integer, integer, text);

-- Function to get count of contacts without tags
CREATE FUNCTION get_contacts_without_tags_count()
...
-- Function to get paginated contacts without tags
CREATE FUNCTION get_contacts_without_tags(
  page_size integer,
  page_number integer,
