---
name: reply-to-send
description: "Send email reply to sender via Railway backend"
version: 1.1.0
...
Invia una reply email (solo al mittente) tramite il backend Railway.
