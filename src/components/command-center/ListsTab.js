...
import {
  ...
  FaChevronRight, FaChevronDown, FaTimes, FaEnvelope, FaSync
} from 'react-icons/fa';
import { supabase } from '../../lib/supabaseClient';
import toast from 'react-hot-toast';

const ListsTab = ({ theme, profileImageModal, onMemberSelect, onSetRightPanelContactId }) => {
  // Lists state
  ...
  // Notify parent to show contact in main action column when member is selected
  useEffect(() => {
    if (onSetRightPanelContactId) {
      onSetRightPanelContactId(selectedMember?.contact_id || null);
    }
  }, [selectedMember, onSetRightPanelContactId]);
