...
import { FaTimes, FaPaperPlane, FaPaperclip, FaRobot, FaCheck, FaImage, FaFileAlt, FaPlus, FaSearch, FaTasks, FaDollarSign, FaExchangeAlt, FaCalendarAlt, FaUserPlus } from 'react-icons/fa';
          ...
          <ComposeColumn theme={theme}>
            ...
            <FormField>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: composeAttachments.length > 0 ? '8px' : 0, flexWrap: 'wrap' }}>
                ...
                <button
                  type="button"
                  onClick={() => onOpenSmartAddContact(composeTo)}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '6px',
