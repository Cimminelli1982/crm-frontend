  ...
  useEffect(() => {
    if (composeModal.open && (composeModal.mode === 'reply' || composeModal.mode === 'replyAll') && !hasAutoGeneratedRef.current) {
      ...
      const timer = setTimeout(() => {
        sendMessageToClaude('Analizza questa email e drafta una risposta appropriata seguendo le istruzioni del system prompt. Usa la stessa lingua dell\'email originale.', { hideUserMessage: true });
      }, 300);
